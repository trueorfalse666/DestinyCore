...
#ifndef DB2LOADINFO_H
#define DB2LOADINFO_H
...
struct CharShipmentLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static DB2FieldMeta const fields[] =
        {
            ...
            { false, FT_INT, "DummyItemID" },
            { false, FT_INT, "OnCompleteSpellID" },
            { false, FT_SHORT, "ContainerID" },
            { false, FT_SHORT, "GarrFollowerID" },
            { false, FT_BYTE, "MaxShipments" },
            { false, FT_BYTE, "Flags" },
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::extent<decltype(fields)>::value, CharShipmentMeta::Instance(), HOTFIX_SEL_CHR_SHIPMENT);
        return &loadInfo;
    }
};
...
struct CharShipmentContainerLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static DB2FieldMeta const fields[] =
        {
            ...
            { true, FT_SHORT, "UiTextureKitID" },
            { true, FT_SHORT, "WorkingDisplayInfoID" },
            { true, FT_SHORT, "SmallDisplayInfoID" },
            { true, FT_SHORT, "MediumDisplayInfoID" },
            { true, FT_SHORT, "LargeDisplayInfoID" },
            { true, FT_SHORT, "CrossFactionID" },
        ...
        static DB2LoadInfo const loadInfo(&fields[0], std::extent<decltype(fields)>::value, CharShipmentContainerMeta::Instance(), HOTFIX_SEL_CHR_SHIPMENT_CONTAINER);
        return &loadInfo;
    }
};
